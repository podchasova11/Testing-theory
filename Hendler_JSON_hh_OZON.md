...
А затем проверить, что совпадает сумма всех заказов "price" и общая сумма заказа "total_amount". Нужно убедиться, что сумма всех товаров, которые находятся внутри заказа, соответствует общей сумме. https://coreapp.ai/app/player/lesson/6485c6d3f92fd9154449876b/6485c6a1f92fd91544498767
