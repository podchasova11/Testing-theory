...
**Use Case** — это описание одного или нескольких сценариев взаимодействия пользователя с системой для достижения определенной цели. В Use Case описываются шаги, которые пользователь и система предпринимают для выполнения задачи.
