...
**Тестирование требований** — это процесс проверки и оценки требований к программному обеспечению или системе с целью удостовериться, что они соответствуют ожиданиям, полны, согласованы и тестируемы. У требований много свойств, которые можно протестировать, но вот два основыные - это 
- Полнота
