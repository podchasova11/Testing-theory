...
Доменные имена регистрируются через регистраторов доменных имен, и за их использование часто взимается ежегодная плата. Если вам интересны детали о процессе регистрации или типах доменов, дайте знать!
