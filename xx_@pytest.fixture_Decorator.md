...
### Декораторы в PyTest
— это мощный инструмент для упрощения и улучшения процесса тестирования в Python. Они позволяют позволить структурировать тесты, добавлять поведение и переопределять параметры, без необходимости создания новых функций или классов. В этой лекции мы рассмотрим основные декораторы, предоставляемые PyTest, и покажем примеры их использования.
