...
Функциональное тестирование — это вид тестирования, направленный на проверку функциональности программного обеспечения в соответствии с требованиями и спецификациями. Оно проверяет, выполняет ли система заявленные функции, правильно ли обрабатываются входные данные и корректно ли генерируются ожидаемые выходные данные.

### Что такое нефункциональное тестирование (Non-Functional testing)?

Нефункциональное тестирование — это вид тестирования, направленный на проверку нефункциональных аспектов системы, таких как производительность, безопасность, удобство использования, совместимость и надежность. Оно оценивает, насколько хорошо система работает, а не что она делает.
...
- **Статическое тестирование**: Процесс проверки программного обеспечения без его выполнения. Включает анализ кода, ревизию документации, инспекции и статический анализ.
- **Динамическое тестирование**: Процесс проверки программного обеспечения с его выполнением. Включает выполнение тестов, проверку поведения программы в различных сценариях и оценку результатов.

### Что такое Черный/Серый/Белый ящик тестирования (White/Black/Grey Box testing)?

- **Черный ящик (Black Box Testing)**: Тестирование, при котором тестировщик не имеет доступа к внутреннему коду или структуре системы. Ориентируется на проверку функциональности, основываясь на входных и выходных данных.
- **Серый ящик (Grey Box Testing)**: Комбинация черного и белого ящика. Тестировщик имеет ограниченные знания о внутренней структуре системы и использует их для разработки более эффективных тестов.
- **Белый ящик (White Box Testing)**: Тестирование, при котором тестировщик имеет полный доступ к исходному коду и внутренней структуре системы. Ориентируется на проверку логики и структуры кода.
...
- **Позитивное тестирование**: Проверка системы на корректное выполнение ее функций при использовании допустимых и правильных данных.
- **Негативное тестирование**: Проверка системы на устойчивость и правильное поведение при использовании недопустимых или неправильных данных.
...
- **Полуавтоматизированное тестирование**: Сочетание ручного и автоматизированного тестирования, где часть тестов выполняется вручную, а часть автоматически.
...
Тестирование безопасности (Security Testing) — это процесс проверки программного обеспечения с целью выявления уязвимостей, угроз и рисков, которые могут привести к утечке данных, несанкционированному доступу или другим нарушениям безопасности. Основная цель — обеспечить защиту данных и поддержание конфиденциальности, целостности и доступности системы.
