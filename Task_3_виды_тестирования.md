...
Функциональное тестирование направлено на проверку функциональности программного обеспечения в соответствии с требованиями и спецификациями. Оно проверяет, выполняет ли система заявленные функции, правильно ли обрабатываются входные данные и корректно ли генерируются ожидаемые выходные данные.
