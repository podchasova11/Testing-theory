...
Функциональное тестирование направлено на проверку функциональности программного обеспечения в соответствии с требованиями и спецификациями. Оно проверяет, выполняет ли система заявленные функции, как правильно обрабатываются входные данные и генерируются ожидаемые выходные данные.
