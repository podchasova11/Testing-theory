...
Функциональное тестирование направлено на проверку функциональности в соответствии с требованиями. Оно проверяет, выполняет ли система заявленные функции, как правильно обрабатываются входные данные и генерируются ожидаемые выходные данные.
