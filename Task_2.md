...
SDLC (Software Development Life Cycle) — это процесс разработки программного обеспечения, состоящий из нескольких этапов.

**Этапы SDLC**:
1. **Планирование (Planning)**: Определение целей, задач и ресурсов проекта
